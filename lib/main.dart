...
void main() {
  runApp(MaterialApp( //material design de android
...
class MyApp extends StatelessWidget { //stateless no se le pueden agregar funcionalidades
  const MyApp({Key? key}) : super(key: key);

  // primera modificacion del codigo fluttter
  @override
  Widget build(BuildContext context) {
    return Scaffold( //lienzo sobre el que se esta trabajando
        appBar: AppBar( //barra de la arte superior
          title: const Text("pagina inicial"),//appBar parte superior
          ),
          body: Container( //contenedor 
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
              ...
              children:  <Widget> [ //const marca un roblema a la hora de agregar una imagen con assets, eliminar
                Icon(               //eliminar assets e ignorar los demas errors en azul
                  Icons.phone_android, //con esta linea se establecen iconos predeterminados
                ...
                SizedBox(width: 20.0),
                Image.asset("assets/img/heriberto.jpg", //agregar imagen desde caretas
                    width: 100.0, //tamano de la imagen
                ),
                SizedBox(height: 20.0,),
                Image.network("https://pixlok.com/wp-content/uploads/2021/05/flutter-logo-768x768.jpg",
                    width: 170.0, //Agregar imagen desde internete con el url de la imagen
                ),
...
class HomePage extends StatelessWidget { //stateless no se le pueden agregar funcionalidades
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold( //lienzo sobre el que se esta trabajando
        appBar: AppBar( //barra de la arte superior
          ...
          backgroundColor: Colors.green, //color de bacground
          ...
          body: Center( //poner los elementos al centro de la pantalla
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            crossAxisAlignment: CrossAxisAlignment.center,
            ...
            children: [
              ...
              onPressed: () {
                ...
                */
                  ...
                  Navigator.pushNamed(context, "/second");//abre la ventana nueva en un archivo dart exterior
              }
            ),
            //tercer screen
              SizedBox(height: 5.0),
              ElevatedButton(
              child: Text("Tercer pantalla"),
              onPressed: () {
                /*
                final route = MaterialPageRoute(
